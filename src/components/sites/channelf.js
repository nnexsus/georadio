        ...
        <div onLoad={() => changeStation(2)} id="channelf" style={{width: '100%', backgroundImage: `url(/images/tile3.jpg)`, paddingTop: '10px'}}>
            <div className='radio' style={{display: 'grid', gridTemplateColumns: '20% 80%'}}>
                <div style={{width: '100%', height: '100%', boxShadow: '0 0 5px 5px black, 0 0 5px 5px black inset', gridColumn: '1', gridRow: '1', display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '0 0 20px 0'}}>
                    ...
                    <img alt='decor' src='/images/channelf/rav1.jpg' width='70%' style={{imageRendering: 'pixelated', cursor: 'pointer', margin: '0 auto'}}/>
                    <img alt='decor' src='/images/channelf/rav2.jpg' width='70%' style={{imageRendering: 'pixelated', cursor: 'pointer', margin: '0 auto'}}/>
                    <img alt='decor' src='/images/channelf/rav3.jpg' width='70%' style={{imageRendering: 'pixelated', cursor: 'pointer', margin: '0 auto'}}/>
                    <img alt='decor' src='/images/channelf/rav4.jpg' width='70%' style={{imageRendering: 'pixelated', cursor: 'pointer', margin: '0 auto'}}/>
                </div>
                <div className='opener' style={{textAlign: 'center', backgroundImage: 'url(/images/tile.jpg)', boxShadow: '0 0 5px 5px black, 0 0 5px 5px black inset', gridColumn: '2', gridRow: '1'}}>
                    ...
                    <div style={{border: 'inset 2px'}}>
                        ...
                        <p style={{color: 'yellow', textShadow: '0 0 5px yellow', fontFamily: 'serif', margin: '0 20px'}}>MAKE SURE TO CHECK OUT <a style={{cursor: 'pointer'}} onClick={() => clickLink('http://www.channelf.co/forum/')}>HTTP://WWW.CHANNELF.CO/FORUM/</a> TO POST YOUR FAVORITE SONGS!!</p>
                    </div>
                    <hr style={{width: '80%', height: '5px'}}/>
                    {radioload ? 
                    <MusicPlayer/>
            ...
            <div style={{display: 'flex', alignItems: 'center'}}>
                ...
                <p>JOIN THE FORUMS!!!!! <a style={{cursor: 'pointer'}} onClick={() => clickLink('http://www.channelf.co/forum/')}>HTTP://WWW.CHANNELF.CO/FORUM/</a>!!</p>
            </div>
        </div>
    )
}
