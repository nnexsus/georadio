        ...
        <div id="http://nightcity.net/" style={{width: '100%', backgroundImage: `url(/images/tile2.jpg)`, backgroundSize: '230px', paddingTop: '10px'}}>
            ...
            <div className='radio' style={{display: 'grid', gridTemplateColumns: '150px 70% 150px'}}>
                ...
                <div style={{width: '100%', height: '100%', margin: '20px 0', backgroundImage: 'url(/images/starbd.gif)', boxShadow: '0 0 5px 5px black, 0 0 5px 5px black inset', display: 'flex'}}>
                    ...
                    <a href='#scrollto' style={{width: '80%', height: '43px', cursor: "url(/images/cursor/pointer.cur), auto"}}><img alt='clickable ad decor' title='http://www.neonsunrise.tl/' onClick={() => clickLink('http://www.neonsunrise.tl/')} src='/images/nightcity/summer_cafe.webp' width='100%' height='43px' style={{imageRendering: 'pixelated'}}/></a>
