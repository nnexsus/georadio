            ...
            <div style={{display: 'grid', gridTemplateColumns: '20% 40% 35%', gridTemplateRows: '200px 160px 400px', gap: '5px', padding: '10px', marginRight: '20px', background: '#007f00', border: 'outset 3px'}} className='home-1'>
                ...
                <div style={{gridColumn: 'span 2', gridRow: 1, margin: '10px'}} className='home-2'>
                    <div style={{display: 'flex'}}>
                        ...
                        <h4 style={{background: 'red'}}>New!! Update 2 is here!! 2 new radios, 6 new sites, and much more!! <a style={{cursor: "url(/images/cursor/pointer.cur), auto", color: 'blue', textDecoration: 'underline'}} href='#scrollto' onClick={() => clickLink('//changelog')} >Changelog</a></h4>
                    </div>
                    <div>
                        <h3>Welcome to GeoRadio!!</h3>
                        <p>Click one of the links to the left to connect to a radio site! (Built-in browser!)</p>
                        <p>Or click here to access the built-in search engine: <a style={{cursor: "url(/images/cursor/pointer.cur), auto", color: 'blue', textDecoration: 'underline'}} href='#scrollto' onClick={() => clickLink('http://arina.com/')}>arina.com</a></p>
                    </div>
                </div>
                ...
                <div style={{gridColumn: 'span 3', gridRow: 2,  width: '100%'}}>
                    <div style={{display: 'grid', gridTemplateColumns: 'repeat(5, 20%)', border: 'inset 3px', width: '100%', background: 'black', padding: '3px'}}>
                        <h2>Radio Links:</h2>
                        <a style={{cursor: "url(/images/cursor/pointer.cur), auto", display: 'flex', alignItems: 'center', border: 'solid green 2px', margin: '3px', background: 'url(/images/home/georadio.png)', backgroundRepeat: 'no-repeat', backgroundPosition: 'center'}} href='#scrollto' onClick={() => clickLink('http://www.geomusic.net/')}>
                        ...
                        <a style={{cursor: "url(/images/cursor/pointer.cur), auto", display: 'flex', alignItems: 'center', border: 'solid green 2px', margin: '3px', background: 'url(/images/home/nightcity.png)', backgroundRepeat: 'no-repeat', backgroundPosition: 'center'}} href='#scrollto' onClick={() => clickLink('http://www.nightcity.net/')}>
                        ...
                        <a style={{cursor: "url(/images/cursor/pointer.cur), auto", display: 'flex', alignItems: 'center', border: 'solid green 2px', margin: '3px', background: 'url(/images/home/channelf.png)', backgroundRepeat: 'no-repeat', backgroundPosition: 'center'}} href='#scrollto' onClick={() => clickLink('http://www.channelf.co/')}>
                        ...
                        <a style={{cursor: "url(/images/cursor/pointer.cur), auto", display: 'flex', alignItems: 'center', border: 'solid green 2px', margin: '3px', background: 'url(/images/home/neonsunrise.png)', backgroundRepeat: 'no-repeat', backgroundPosition: 'center'}} href='#scrollto' onClick={() => clickLink('http://www.neonsunrise.tl/')}>
                        ...
                        <a style={{cursor: "url(/images/cursor/pointer.cur), auto", display: 'flex', alignItems: 'center', border: 'solid green 2px', margin: '3px', background: 'url(/images/home/neonsunset.png)', backgroundRepeat: 'no-repeat', backgroundPosition: 'center'}} href='#scrollto' onClick={() => clickLink('http://www.neonsunset.tl/')}>
                        ...
                        <a style={{cursor: "url(/images/cursor/pointer.cur), auto", display: 'flex', alignItems: 'center', border: 'solid green 2px', margin: '3px', background: 'url(/images/home/moemoejp.png)', backgroundRepeat: 'no-repeat', backgroundPosition: 'center'}} href='#scrollto' onClick={() => clickLink('http://www.moemoe.jp/home')}>
                            <p style={{background: 'rgba(0, 0, 0, 0.5)'}}>Moe</p><img alt='new' style={{imageRendering: 'pixelated'}} src='/images/new2.gif' width={'48px'}/>
                        </a>
                        <a style={{cursor: "url(/images/cursor/pointer.cur), auto", display: 'flex', alignItems: 'center', border: 'solid green 2px', margin: '3px', background: 'url(/images/home/liquidelectrum.png)', backgroundRepeat: 'no-repeat', backgroundPosition: 'center'}} href='#scrollto' onClick={() => clickLink('http://www.liquidelectrum.co/main')}>
                ...
                <div style={{border: 'inset 3px', gridRow: 3, gridColumn: 3, background: 'black', padding: '3px'}}>
                    ...
                    <div style={{padding: '10px', background: 'black'}}>
                        ...
                        <p style={{textIndent: '10px'}}>If the mouse appears like this: <a href='#scrollto'>(hover me)</a>, then it directs outside the site. If the mouse appears like this: 
                        <a href='#scrollto' style={{cursor: "url(/images/cursor/pointer.cur), auto"}}>(hover me)</a> then it directs in-site.</p>
                        <div style={{display: 'flex'}}>
                            <div style={{display: 'flex'}}>
