...
const ContextMenu = () => {
    ...
    return (
        <div id='context-menu' className='dontclose' style={{position: 'absolute', left: `${state.contextPos[0]}px`, top: `${state.contextPos[1]}px`, background: '#C0C7C8', width: '110px', height: '150px', outline: 'black solid 1px', outlineOffset: '-1px'}}>
